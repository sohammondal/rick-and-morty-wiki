(this["webpackJsonprick-and-morty-wiki"]=this["webpackJsonprick-and-morty-wiki"]||[]).push([[0],{112:function(t,e,a){"use strict";a.r(e);var i=a(165),n=a(160),r=a(118),o=a(0),c=a.n(o),s=a(74),l=a.n(s),d=a(45),C=a(42),h=a(16),u=a(73),j=a(28),b=a(30);const g=Object(h.b)("characters/getCharacters",(async(t,e)=>{try{var a,i;const n=null===(a=await Object(j.b)(t))||void 0===a?void 0:a.data,r={};null===n||void 0===n||null===(i=n.results)||void 0===i||i.forEach((t=>{t.location.url&&(r[t.location.url]=t.location.url),t.origin.url&&(r[t.origin.url]=t.origin.url)}));const o=Object.values(r);return o.length&&e.dispatch(Object(b.a)(o)),n}catch(n){n&&(console.error(n.toString()),e.rejectWithValue(n.toString()))}})),f={info:{},data:[],isLoading:!0},p=Object(h.c)({name:"characters",initialState:f,reducers:{resetState:()=>f},extraReducers:t=>{t.addCase(g.pending,(t=>{t.isLoading=!0})).addCase(g.fulfilled,((t,e)=>{var a,i;t.isLoading=!1,t.info=null===e||void 0===e||null===(a=e.payload)||void 0===a?void 0:a.info,null!==e&&void 0!==e&&null!==(i=e.payload)&&void 0!==i&&i.results&&(t.data=[...t.data,...e.payload.results])})).addCase(g.rejected,(t=>{t.isLoading=!1}))}});var x=p.reducer;const v=p.actions;var O=a(54);const m={characters:x,locations:Object(h.c)({name:"locations",initialState:{data:{},isLoading:!1},reducers:{},extraReducers:t=>{t.addCase(b.a.pending,(t=>{t.isLoading=!0})).addCase(b.a.fulfilled,((t,e)=>{var a,i;Array.isArray(e.payload)?e.payload.forEach((e=>{t.data[e.url]=e})):null!==e&&void 0!==e&&null!==(a=e.payload)&&void 0!==a&&a.url&&(t.data[null===e||void 0===e||null===(i=e.payload)||void 0===i?void 0:i.url]=e.payload);t.isLoading=!1})).addCase(b.a.rejected,(t=>{t.isLoading=!1}))}}).reducer,episodes:O.a,character:u.b},y=Object(h.a)({reducer:m});var w=a(83);const L=Object(w.a)({});var k=a(6),$=a(17);const S=$.a.footer`
  position: fixed;
  width: max-content;
  background: #3c3e44;
  color: #fff;
...
`,B=$.a.div`
  ${W.d}
  flex-wrap: wrap;
`;var F=a(85),U=a(31);var D=a(171),T=a(161),q=a(173),H=a(172),J=a(170),_=a(169);const G=$.a.div`
  ${W.e.custom(10,"px")}
  border-radius: 50%;
...
`,X={Alive:"green",Dead:"red",unknown:"gray"},Y=t=>{let{character:e,location:a,origin:i}=t;const n=Object(k.n)(),r={species:(null===e||void 0===e?void 0:e.species)||"unknown",origin:`${(null===i||void 0===i?void 0:i.name)||"unknown"} ${null!==i&&void 0!==i&&i.type?` \u2022 ${i.type}`:""}`,location:`${(null===a||void 0===a?void 0:a.name)||"unknown"} ${null!==a&&void 0!==a&&a.type?` \u2022 ${a.type}`:""}`};return null!==e&&void 0!==e&&e.name?Object(N.jsx)(Q,{"data-testid":"character-card",children:Object(N.jsxs)(D.a,{className:"card-action-area",onClick:()=>{n(`/character/${e.id}`,{state:{character:e,location:a,origin:i}})},children:[Object(N.jsx)(H.a,{component:"img",image:e.image,alt:`picture of ${e.name}`,className:"card-media"}),Object(N.jsxs)(q.a,{className:"card-content",children:[Object(N.jsxs)("div",{className:"character-name",children:[Object(N.jsx)(T.a,{title:e.status,arrow:!0,children:Object(N.jsx)(G,{color:X[e.status]})}),Object(N.jsx)(J.a,{gutterBottom:!0,variant:"h5",children:e.name})]}),Object.keys(r).map((t=>Object(N.jsxs)(K,{children:[Object(N.jsx)(J.a,{variant:"body2",color:"text.secondary",children:t}),Object(N.jsx)(J.a,{variant:"body1",color:"text.primary",children:r[t]})]},t)))]})]})}):Object(N.jsx)(Q,{"data-testid":"character-card",children:Object(N.jsx)(J.a,{variant:"h3",children:"Loading"})})},tt=()=>{const{characters:t,locations:e,infiniteSrollRef:a,isLoading:i,hasNextPage:n}=(()=>{var t,e,a;const i=Object(U.a)(),n=Object(U.b)((t=>t.characters)),r=Object(U.b)((t=>t.locations)),c=n.isLoading||r.isLoading,s=null!==n&&void 0!==n&&null!==(t=n.info)&&void 0!==t&&t.next?new URL(null===n||void 0===n||null===(e=n.info)||void 0===e?void 0:e.next):"",l=s?null===s||void 0===s||null===(a=s.searchParams)||void 0===a?void 0:a.get("page"):2,d=!!l;Object(o.useEffect)((()=>{i(v.resetState()),i(g({page:1}))}),[]);const[C]=Object(F.a)({loading:c,hasNextPage:d,onLoadMore:()=>i(g({page:Number(l)})),rootMargin:"0px 0px 10px 0px",delayInMs:1e3});return{locations:r.data,characters:n.data,isLoading:c,hasNextPage:d,infiniteSrollRef:C}})();return Object(N.jsxs)(Z,{children:[Object(N.jsx)(B,{children:t.map((t=>Object(N.jsx)(Y,{character:t,location:e[t.location.url],origin:e[t.origin.url]},t.id)))}),(n||i)&&Object(N.jsx)(V.a,{ref:a})]})};var et=a(80),at=a(84),it=a(81),nt=a(158);const rt=$.a.section`
  display: block;
...
`,ot=$.a.div`
  ${W.d}
  flex-wrap: wrap;
`;function ct(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1;if(!Array.isArray(t))return[];if(e<1)throw new Error("chunkOf cannot be < 1");if(isNaN(e))throw new Error("chunkOf has to be number");const a=[...t],i=[];for(;a.length;)i.push(a.splice(0,e));return i}const st=t=>{let{index:e,style:a,data:i}=t;const{characters:n,locations:r}=i||{characters:[]},o=n[e];return o?Object(N.jsx)(ot,{style:a,children:o.map((t=>Object(N.jsx)(Y,{character:t,location:r[t.location.url],origin:r[t.origin.url]},t.id)))}):null},lt=()=>{const t={desktopLarge:Object(nt.a)("(min-width: 1920px)"),desktop:Object(nt.a)("(min-width: 1366px)"),tabletLandscape:Object(nt.a)("(min-width: 1024px)"),tabletPortrait:Object(nt.a)("(min-width: 768px)"),phone:Object(nt.a)("(min-width: 600px)")},e=(()=>{let e=1;return t?(t.desktopLarge?e=3:t.desktop?e=2:(t.tabletLandscape||t.tabletPortrait||t.phone)&&(e=1),e):e})(),a=(()=>{let e=550;return t?(t.desktop||t.tabletLandscape||t.tabletPortrait?e=250:t.phone&&(e=550),e):e})(),{characters:i,locations:n,loadMore:r,totalCharacters:c}=(t=>{var e,a,i,n;let{groupOf:r}=t;const c=Object(U.a)(),s=Object(U.b)((t=>t.characters)),l=Object(U.b)((t=>t.locations)),d=s.isLoading||l.isLoading,C=null!==s&&void 0!==s&&null!==(e=s.info)&&void 0!==e&&e.next?new URL(null===s||void 0===s||null===(a=s.info)||void 0===a?void 0:a.next):"",h=C?null===C||void 0===C||null===(i=C.searchParams)||void 0===i?void 0:i.get("page"):2,u=!!h;return Object(o.useEffect)((()=>{c(v.resetState()),c(g({page:1}))}),[]),{totalCharacters:(null===(n=s.info)||void 0===n?void 0:n.count)||s.data.length,locations:l.data,characters:ct(s.data,r),isLoading:d,hasNextPage:u,loadMore:()=>c(g({page:Number(h)}))}})({groupOf:e});return Object(N.jsx)(rt,{children:Object(N.jsx)(et.a,{children:t=>{let{height:e,width:o}=t;return Object(N.jsx)(it.a,{isItemLoaded:t=>t<i.length&&null!==i[t],itemCount:c,loadMoreItems:r,children:t=>{let{onItemsRendered:r,ref:s}=t;return Object(N.jsx)(at.a,{height:e,width:o,itemCount:c,itemSize:a,itemData:{characters:i,locations:n},onItemsRendered:r,ref:s,children:st})}})}})})};var dt=a(159),Ct=a(176),ht=a(175);const ut=Object(o.createContext)({loadingStrategy:"infinite-scroll",setLoadingStrategy:t=>{}});ut.displayName="CharactersContext";const jt=()=>Object(o.useContext)(ut),bt=t=>{let{children:e}=t;const[a,i]=Object(o.useState)("infinite-scroll");return Object(N.jsx)(ut.Provider,{value:{loadingStrategy:a,setLoadingStrategy:t=>{i(t)}},children:e})},gt=()=>{const{loadingStrategy:t,setLoadingStrategy:e}=jt();return Object(N.jsxs)(ht.a,{sx:{padding:"1.8rem"},size:"small",children:[Object(N.jsx)(Ct.a,{variant:"infinite-scroll"===t?"contained":"outlined",style:{color:"infinite-scroll"===t?"white":"inherit"},onClick:()=>{e("infinite-scroll")},endIcon:Object(N.jsx)(T.a,{title:'Infinite scroll is a web design technique that automatically loads new content as a user scrolls down a page, creating a seemingly endless supply of information. This method eliminates the need for pagination or clicking "Next" to access more content.',children:Object(N.jsx)(dt.a,{})}),children:"infinite scroll"}),Object(N.jsx)(Ct.a,{style:{color:"virtualized-list"===t?"white":"inherit"},onClick:()=>{e("virtualized-list")},variant:"virtualized-list"===t?"contained":"outlined",endIcon:Object(N.jsx)(T.a,{title:"A virtualized list is a technique used in React to improve the performance of rendering large lists of data. It works by only rendering the items that are currently visible in the viewport, and keeping the rest of the items in a virtual state. This can significantly improve the performance of applications with large lists, as it reduces the amount of work that the browser has to do.",children:Object(N.jsx)(dt.a,{})}),children:"virtualized list"})]})},ft=()=>{const{loadingStrategy:t}=jt();return Object(N.jsxs)(z.a,{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",children:[Object(N.jsx)(gt,{}),"infinite-scroll"===t?Object(N.jsx)(tt,{}):Object(N.jsx)(lt,{})]})},pt=()=>Object(N.jsx)(bt,{children:Object(N.jsx)(ft,{})}),xt=$.a.section`
  ${W.d}
  text-align: center;
  position: relative;
  width: 100%;
...
`),C={full:i.b`
  ...
  `,custom:function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:20,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"%",a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0;return i.b`
    height: ${t}${e};
    width: ${a||t}${e};
  `}}},28:function(t,e,a){"use strict";a.d(e,"b",(function(){return r})),a.d(e,"a",(function(){return o})),a.d(e,"c",(function(){return c})),a.d(e,"d",(function(){return s}));const i=t=>{const e=new URLSearchParams;return Object.entries(t).forEach((t=>{let[a,i]=t;void 0!==i&&null!==i&&e.append(a,String(i))})),e.toString()},n=async t=>{const e=await fetch(`https://rickandmortyapi.com/api${t}`);return{data:e.ok?await e.json():{},status:e.status,statusMessage:e.statusText}},r=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return n(`/character/?${i(t)}`)},o=t=>n(`/character/${Array.isArray(t)?t.join(","):t}`),c=t=>n(`/episode/${Array.isArray(t)?t.join(","):t}`),s=t=>n(`/location/${Array.isArray(t)?t.join(","):t}`)},30:function(t,e,a){"use strict";a.d(e,"a",(function(){return o}));var i=a(16),n=a(28),r=a(50);const o=Object(i.b)("locations/getLocation",(async(t,e)=>{try{const a=e.getState(),i={};null===t||void 0===t||t.forEach((t=>{if(t&&!a.locations.data[t]){const e=Object(r.a)(t);e&&(i[e]=e)}}));const o=Object.values(i);let c={};if(o.length&&(c=(await Object(n.d)(o)).data),1===o.length)return c;if(o.length>1)return c}catch(a){if(a)return console.error(a.toString()),e.rejectWithValue(a.toString())}}))},31:function(t,e,a){"use strict";a.d(e,"b",(function(){return n})),a.d(e,"a",(function(){return r}));var i=a(45);const n=i.c,r=()=>Object(i.b)()},50:function(t,e,a){"use strict";a.d(e,"a",(function(){return i}));const i=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"";if(!t||"string"!==typeof t)throw new Error("`str` must be of type string");const e=t.match(/\d/g);if(!e)throw new Error("no numbers found");const a=null===e||void 0===e?void 0:e.join("");return Number(a)}},54:function(t,e,a){"use strict";a.d(e,"b",(function(){return o}));var i=a(16),n=a(28),r=a(50);const o=Object(i.b)("episodes/getEpisode",(async(t,e)=>{try{const a=e.getState(),i=[];t.forEach((t=>{const e=Object(r.a)(t);e&&!a.episodes.data[t]&&i.push(e)}));let o={};if(i.length&&(o=(await Object(n.c)(i)).data),1===i.length)return o;if(i.length>1)return o}catch(a){if(a)return console.error(a.toString()),e.rejectWithValue(a.toString())}})),c=Object(i.c)({name:"episodes",initialState:{data:{},isLoading:!1},reducers:{},extraReducers:t=>{t.addCase(o.pending,(t=>{t.isLoading=!0})).addCase(o.fulfilled,((t,e)=>{var a,i;Array.isArray(e.payload)?e.payload.forEach((e=>{t.data[e.url]=e})):null!==e&&void 0!==e&&null!==(a=e.payload)&&void 0!==a&&a.url&&(t.data[null===e||void 0===e||null===(i=e.payload)||void 0===i?void 0:i.url]=e.payload);t.isLoading=!1})).addCase(o.rejected,(t=>{t.isLoading=!1}))}});e.a=c.reducer},73:function(t,e,a){"use strict";a.d(e,"c",(function(){return c})),a.d(e,"a",(function(){return d}));var i=a(16),n=a(28),r=a(54),o=a(30);const c=Object(i.b)("character/getCharacter",(async(t,e)=>{try{let{character:a,location:i,origin:c}=t,s=[];if("number"===typeof a){if(isNaN(a))return e.rejectWithValue("404: Character not found");const t=await Object(n.a)(a);if(200!==t.status)return e.rejectWithValue(`${t.status}: ${t.statusMessage}`);a=t.data;const r={};a.location.url&&(r[a.location.url]=a.location.url),a.origin.url&&(r[a.origin.url]=a.origin.url);const s=Object.values(r);if(s.length){const t=a;await e.dispatch(Object(o.a)(s));const n=e.getState();i=t.location.url?n.locations.data[t.location.url]:i,c=t.origin.url?n.locations.data[t.origin.url]:c}}await e.dispatch(Object(r.b)(a.episode));const l=e.getState();return s=a.episode.map((t=>l.episodes.data[t])),{character:a,location:i,origin:c,episodes:s}}catch(a){if(!a)return;console.error(a),e.rejectWithValue(a)}})),s={character:{},location:{},origin:{},episodes:[],isLoading:!0,error:null},l=Object(i.c)({name:"character",initialState:s,reducers:{resetState:()=>s},extraReducers:t=>{t.addCase(c.pending,(t=>{t.isLoading=!0})).addCase(c.fulfilled,((t,e)=>{var a,i,n,r;t.character=(null===(a=e.payload)||void 0===a?void 0:a.character)||s.character,t.location=(null===(i=e.payload)||void 0===i?void 0:i.location)||s.location,t.origin=(null===(n=e.payload)||void 0===n?void 0:n.origin)||s.origin,t.episodes=(null===(r=e.payload)||void 0===r?void 0:r.episodes)||s.episodes,t.isLoading=!1})).addCase(c.rejected,((t,e)=>{t.isLoading=!1,t.error=e.payload}))}});e.b=l.reducer;const d=l.actions}},[[112,1,2]]]);
//# sourceMappingURL=main.810ae4f8.chunk.js.map