(this["webpackJsonprick-and-morty-wiki"]=this["webpackJsonprick-and-morty-wiki"]||[]).push([[0],{112:function(t,e,a){"use strict";a.r(e);var i=a(170),n=a(164),r=a(119),o=a(0),c=a.n(o),s=a(76),l=a.n(s),d=a(46),C=a(43),h=a(17),u=a(75),g=a(30),b=a(32);const j=Object(h.b)("characters/getCharacters",(async(t,e)=>{try{var a,i;const n=null===(a=await Object(g.b)(t))||void 0===a?void 0:a.data,r={};null===n||void 0===n||null===(i=n.results)||void 0===i||i.forEach((t=>{t.location.url&&(r[t.location.url]=t.location.url),t.origin.url&&(r[t.origin.url]=t.origin.url)}));const o=Object.values(r);return o.length&&e.dispatch(Object(b.a)(o)),n}catch(n){n&&(console.error(n.toString()),e.rejectWithValue(n.toString()))}})),f={info:{},data:[],isLoading:!0},p=Object(h.c)({name:"characters",initialState:f,reducers:{resetState:()=>f},extraReducers:t=>{t.addCase(j.pending,(t=>{t.isLoading=!0})).addCase(j.fulfilled,((t,e)=>{var a,i;t.isLoading=!1,t.info=null===e||void 0===e||null===(a=e.payload)||void 0===a?void 0:a.info,null!==e&&void 0!==e&&null!==(i=e.payload)&&void 0!==i&&i.results&&(t.data=[...t.data,...e.payload.results])})).addCase(j.rejected,(t=>{t.isLoading=!1}))}});var v=p.reducer;const x=p.actions;var O=a(56);const m={characters:v,locations:Object(h.c)({name:"locations",initialState:{data:{},isLoading:!1},reducers:{},extraReducers:t=>{t.addCase(b.a.pending,(t=>{t.isLoading=!0})).addCase(b.a.fulfilled,((t,e)=>{var a,i;Array.isArray(e.payload)?e.payload.forEach((e=>{t.data[e.url]=e})):null!==e&&void 0!==e&&null!==(a=e.payload)&&void 0!==a&&a.url&&(t.data[null===e||void 0===e||null===(i=e.payload)||void 0===i?void 0:i.url]=e.payload);t.isLoading=!1})).addCase(b.a.rejected,(t=>{t.isLoading=!1}))}}).reducer,episodes:O.a,character:u.b},y=Object(h.a)({reducer:m});var w=a(85);const L=Object(w.a)({});var k=a(6),$=a(15);const S=$.a.footer`
  position: fixed;
  width: max-content;
  background: #3c3e44;
  color: #fff;
...
`,B=$.a.div`
  ${W.d}
  flex-wrap: wrap;
`;var U=a(87),F=a(24);var D=a(176),T=a(165),q=a(178),H=a(177),J=a(175),_=a(174);const G=$.a.div`
  ${W.e.custom(10,"px")}
  border-radius: 50%;
...
`,X={Alive:"green",Dead:"red",unknown:"gray"},Y=t=>{let{character:e,location:a,origin:i}=t;const n=Object(k.n)(),r={species:(null===e||void 0===e?void 0:e.species)||"unknown",origin:`${(null===i||void 0===i?void 0:i.name)||"unknown"} ${null!==i&&void 0!==i&&i.type?` \u2022 ${i.type}`:""}`,location:`${(null===a||void 0===a?void 0:a.name)||"unknown"} ${null!==a&&void 0!==a&&a.type?` \u2022 ${a.type}`:""}`};return null!==e&&void 0!==e&&e.name?Object(P.jsx)(Q,{"data-testid":"character-card",children:Object(P.jsxs)(D.a,{className:"card-action-area",onClick:()=>{n(`/character/${e.id}`,{state:{character:e,location:a,origin:i}})},children:[Object(P.jsx)(H.a,{component:"img",image:e.image,alt:`picture of ${e.name}`,className:"card-media"}),Object(P.jsxs)(q.a,{className:"card-content",children:[Object(P.jsxs)("div",{className:"character-name",children:[Object(P.jsx)(T.a,{title:e.status,arrow:!0,children:Object(P.jsx)(G,{color:X[e.status]})}),Object(P.jsx)(J.a,{gutterBottom:!0,variant:"h5",children:e.name})]}),Object.keys(r).map((t=>Object(P.jsxs)(K,{children:[Object(P.jsx)(J.a,{variant:"body2",color:"text.secondary",children:t}),Object(P.jsx)(J.a,{variant:"body1",color:"text.primary",children:r[t]})]},t)))]})]})}):Object(P.jsx)(Q,{"data-testid":"character-card",children:Object(P.jsx)(J.a,{variant:"h3",children:"Loading"})})},tt=()=>{const{characters:t,locations:e,infiniteSrollRef:a,isLoading:i,hasNextPage:n}=(()=>{var t,e,a;const i=Object(F.a)(),n=Object(F.b)((t=>t.characters)),r=Object(F.b)((t=>t.locations)),c=n.isLoading||r.isLoading,s=null!==n&&void 0!==n&&null!==(t=n.info)&&void 0!==t&&t.next?new URL(null===n||void 0===n||null===(e=n.info)||void 0===e?void 0:e.next):"",l=s?null===s||void 0===s||null===(a=s.searchParams)||void 0===a?void 0:a.get("page"):2,d=!!l;Object(o.useEffect)((()=>{i(x.resetState()),i(j({page:1}))}),[]);const[C]=Object(U.a)({loading:c,hasNextPage:d,onLoadMore:()=>i(j({page:Number(l)})),rootMargin:"0px 0px 10px 0px",delayInMs:1e3});return{locations:r.data,characters:n.data,isLoading:c,hasNextPage:d,infiniteSrollRef:C}})();return Object(P.jsxs)(Z,{children:[Object(P.jsx)(B,{children:t.map((t=>Object(P.jsx)(Y,{character:t,location:e[t.location.url],origin:e[t.origin.url]},t.id)))}),(n||i)&&Object(P.jsx)(V.a,{ref:a})]})};var et=a(166);const at=$.a.section`
  ${W.a}
  align-items: center;
  padding: 5vh 15px;
...
`,rt=()=>{const{characters:t,locations:e,isLoading:a,page:i,totalPages:n,setPage:r}=(()=>{var t;const e=Object(F.a)(),[a,i]=Object(o.useState)(1),n=Object(F.b)((t=>t.characters)),r=Object(F.b)((t=>t.locations)),c=n.isLoading||r.isLoading;return Object(o.useEffect)((()=>{e(x.resetState()),e(j({page:a}))}),[a]),{locations:r.data,characters:n.data,isLoading:c,page:a,totalPages:(null===(t=n.info)||void 0===t?void 0:t.pages)||1,setPage:i}})();return Object(P.jsxs)(at,{children:[Object(P.jsx)(it,{children:a?Object(P.jsx)(V.a,{}):t.map((t=>Object(P.jsx)(Y,{character:t,location:e[t.location.url],origin:e[t.origin.url]},t.id)))}),Object(P.jsx)(nt,{children:Object(P.jsx)(et.a,{count:n,page:i,onChange:(t,e)=>r(e),disabled:a,variant:"outlined",shape:"rounded",siblingCount:0})})]})};var ot=a(82),ct=a(86),st=a(83),lt=a(162);const dt=$.a.section`
  display: block;
...
`,Ct=$.a.div`
  ${W.d}
  flex-wrap: wrap;
`;function ht(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1;if(!Array.isArray(t))return[];if(e<1)throw new Error("chunkOf cannot be < 1");if(isNaN(e))throw new Error("chunkOf has to be number");const a=[...t],i=[];for(;a.length;)i.push(a.splice(0,e));return i}const ut=t=>{let{index:e,style:a,data:i}=t;const{characters:n,locations:r}=i||{characters:[]},o=n[e];return o?Object(P.jsx)(Ct,{style:a,children:o.map((t=>Object(P.jsx)(Y,{character:t,location:r[t.location.url],origin:r[t.origin.url]},t.id)))}):null},gt=()=>{const t={desktopLarge:Object(lt.a)("(min-width: 1920px)"),desktop:Object(lt.a)("(min-width: 1366px)"),tabletLandscape:Object(lt.a)("(min-width: 1024px)"),tabletPortrait:Object(lt.a)("(min-width: 768px)"),phone:Object(lt.a)("(min-width: 600px)")},e=(()=>{let e=1;return t?(t.desktopLarge?e=3:t.desktop?e=2:(t.tabletLandscape||t.tabletPortrait||t.phone)&&(e=1),e):e})(),a=(()=>{let e=550;return t?(t.desktop||t.tabletLandscape||t.tabletPortrait?e=250:t.phone&&(e=550),e):e})(),{characters:i,locations:n,loadMore:r,totalCharacters:c}=(t=>{var e,a,i,n;let{groupOf:r}=t;const c=Object(F.a)(),s=Object(F.b)((t=>t.characters)),l=Object(F.b)((t=>t.locations)),d=s.isLoading||l.isLoading,C=null!==s&&void 0!==s&&null!==(e=s.info)&&void 0!==e&&e.next?new URL(null===s||void 0===s||null===(a=s.info)||void 0===a?void 0:a.next):"",h=C?null===C||void 0===C||null===(i=C.searchParams)||void 0===i?void 0:i.get("page"):2,u=!!h;return Object(o.useEffect)((()=>{c(x.resetState()),c(j({page:1}))}),[]),{totalCharacters:(null===(n=s.info)||void 0===n?void 0:n.count)||s.data.length,locations:l.data,characters:ht(s.data,r),isLoading:d,hasNextPage:u,loadMore:()=>c(j({page:Number(h)}))}})({groupOf:e});return Object(P.jsx)(dt,{children:Object(P.jsx)(ot.a,{children:t=>{let{height:e,width:o}=t;return Object(P.jsx)(st.a,{isItemLoaded:t=>t<i.length&&null!==i[t],itemCount:c,loadMoreItems:r,children:t=>{let{onItemsRendered:r,ref:s}=t;return Object(P.jsx)(ct.a,{height:e,width:o,itemCount:c,itemSize:a,itemData:{characters:i,locations:n},onItemsRendered:r,ref:s,children:ut})}})}})})};var bt=a(163),jt=a(181),ft=a(180);const pt=Object(o.createContext)({loadingStrategy:"infinite-scroll",setLoadingStrategy:t=>{}});pt.displayName="CharactersContext";const vt=()=>Object(o.useContext)(pt),xt=t=>{let{children:e}=t;const[a,i]=Object(o.useState)("infinite-scroll");return Object(P.jsx)(pt.Provider,{value:{loadingStrategy:a,setLoadingStrategy:t=>{i(t)}},children:e})},Ot=()=>{const{loadingStrategy:t,setLoadingStrategy:e}=vt();return Object(P.jsxs)(ft.a,{sx:{padding:"1.8rem"},size:"small",children:[Object(P.jsx)(jt.a,{variant:"infinite-scroll"===t?"contained":"outlined",style:{color:"infinite-scroll"===t?"white":"inherit"},onClick:()=>{e("infinite-scroll")},endIcon:Object(P.jsx)(T.a,{title:'Infinite scroll is a web design technique that automatically loads new content as a user scrolls down a page, creating a seemingly endless supply of information. This method eliminates the need for pagination or clicking "Next" to access more content.',children:Object(P.jsx)(bt.a,{})}),children:"infinite scroll"}),Object(P.jsx)(jt.a,{style:{color:"virtualized-list"===t?"white":"inherit"},onClick:()=>{e("virtualized-list")},variant:"virtualized-list"===t?"contained":"outlined",endIcon:Object(P.jsx)(T.a,{title:"A virtualized list is a technique used in React to improve the performance of rendering large lists of data. It works by only rendering the items that are currently visible in the viewport, and keeping the rest of the items in a virtual state. This can significantly improve the performance of applications with large lists, as it reduces the amount of work that the browser has to do.",children:Object(P.jsx)(bt.a,{})}),children:"virtualized list"}),Object(P.jsx)(jt.a,{style:{color:"pagination"===t?"white":"inherit"},onClick:()=>{e("pagination")},variant:"pagination"===t?"contained":"outlined",endIcon:Object(P.jsx)(T.a,{title:"Pagination splits content across discrete, numbered pages and lets the user jump directly to any of them. Unlike infinite scroll, it only ever loads one page of data at a time and gives the user explicit control over navigation.",children:Object(P.jsx)(bt.a,{})}),children:"pagination"})]})},mt=()=>{const{loadingStrategy:t}=vt();return Object(P.jsxs)(z.a,{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",children:[Object(P.jsx)(Ot,{}),"infinite-scroll"===t&&Object(P.jsx)(tt,{}),"virtualized-list"===t&&Object(P.jsx)(gt,{}),"pagination"===t&&Object(P.jsx)(rt,{})]})},yt=()=>Object(P.jsx)(xt,{children:Object(P.jsx)(mt,{})}),wt=$.a.section`
  ${W.d}
  text-align: center;
  position: relative;
  width: 100%;
